...
Vamos a empezar por el ejemplo [echobot](https://github.com/javacasm/CursoPython/raw/master/codigo/10.4.0.echoBot.py), un ejemplo de Bot de Telegram que repite lo que le decimos. He modificado lévemente el codigo para que en caso de que el mensaje sea "hi" conteste con un mensaje especial usando el nombre del usuario 
...
Vamos a aprovechar que modularizamos el Juego de las 20 preguntas para integrarlo en un bot de Telegram.
