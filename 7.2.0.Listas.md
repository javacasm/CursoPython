...
Una lista es una colección que nos permite almacenar varios valores juntos.
...
Podemos crear una lista vacia con
...
También podemos buscar en una lista con la palabra reservada **in**, lo que nos devolverá un booleano
