...
```
2. En lugar de dibujar el rectángulo copiaremos la imagen en x,y, tras rellenar el fondo
```python
...
Puedes descargar los recursos necesarios (imágenes y música) de [este enlace](https://github.com/javacasm/CursoPython/raw/master/codigo/recursos_11.4.zip) y el código final de [aquí](https://raw.githubusercontent.com/javacasm/CursoPython/master/codigo/11.4.Tut08.1.5_movimientoImagen.py)
