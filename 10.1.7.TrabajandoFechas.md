...
time.struct_time(tm_year=2022, tm_mon=9, tm_mday=29, tm_hour=14, tm_min=25, tm_sec=49, tm_wday=3, tm_yday=272, tm_isdst=1)
...
También podemos usar *calendar*, como su nombre indica, para mostrar un calendario. Por ejemplo, el método *month(yy,mm)* devuelve una cadena con un calendario del mes mm del año yy:
